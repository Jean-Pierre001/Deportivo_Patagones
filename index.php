...
<body class="bg-gray-50 transition-colors duration-300">
    ...
    <header class="hero-image-background py-20 -mt-[65px] h-[70vh] flex items-center justify-center">
        <div class="container mx-auto px-4 text-center hero-content pt-20">
            ...
            <a href="#contacto" class="bg-green-600 hover:bg-green-500 text-white px-8 py-3 rounded-lg font-bold text-lg transition inline-block shadow-xl">
                Ver Instalaciones
            </a>
        </div>
    </header>
    ...
    <section id="instalaciones" class="py-16 bg-gray-100">
        <div class="container mx-auto px-4">
            ...
            <div class="flex justify-center space-x-4 mb-10">
                <button class="filter-btn bg-gray-200 hover:bg-gray-300 px-5 py-2 rounded-full font-semibold transition" data-filter="all">Todos</button>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="card bg-white rounded-xl shadow-lg hover:shadow-2xl transition duration-300 card-hover" data-category="futbol">
                    <img src="https://tse3.mm.bing.net/th/id/OIP.2lrqqAiVStJi1gZSlagSfwHaFj?cb=12&w=474&h=474&c=7&p=0" alt="Cancha de Fútbol" class="rounded-t-xl h-56 w-full object-cover">
                    <div class="p-6">
                        <h4 class="text-2xl font-bold text-gray-800 mb-2">Canchas de Fútbol</h4>
                        <span class="inline-block bg-red-500 text-white text-xs px-3 py-1 rounded-full font-semibold mb-3">Deportivo</span>
                        ...
                        <button 
                            class="select-facility-btn w-full bg-green-600 hover:bg-green-500 text-white py-2 rounded-lg font-bold transition"
                ...
                <div class="card bg-white rounded-xl shadow-lg hover:shadow-2xl transition duration-300 card-hover" data-category="salon">
                    <img src="https://luxeventos.mx/wp-content/uploads/2020/12/IMG_6281.jpg" alt="Salón de Eventos" class="rounded-t-xl h-56 w-full object-cover">
                    <div class="p-6">
                ...
                <div class="card bg-white rounded-xl shadow-lg hover:shadow-2xl transition duration-300 card-hover" data-category="albergue">
                    <img src="https://images.adsttc.com/media/images/6373/956f/62d1/0b51/d173/071c/slideshow/de-hostel-studio-apl_3.jpg?1668519299=" alt="Albergue Deportivo" class="rounded-t-xl h-56 w-full object-cover">
                    <div class="p-6">
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const maxScroll = 100; // O 150 en checkout.html y turnos.html
    ...
    // Seleccionamos todos los botones con la clase "filter-btn"
    const botones = document.querySelectorAll(".filter-btn");

    botones.forEach(boton => {
        boton.addEventListener("click", function () {
            // Primero quitamos la clase activa (verde) de todos
            botones.forEach(b => {
                b.classList.remove("bg-green-500", "text-white");
                b.classList.add("bg-gray-200", "text-black");
            });

            // Luego activamos el botón clickeado
